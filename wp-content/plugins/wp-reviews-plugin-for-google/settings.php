...
href="<?php  echo admin_url('admin.php?page='.$trustindex_pm_google->get_plugin_slug().'/settings.php&tab='.$action); ?>"
><?php  echo $tab_name; ?></a>
				<?php endforeach; ?>
...
href="<?php  echo admin_url('admin.php?page='.$trustindex_pm_google->get_plugin_slug().'/settings.php&tab='.$tab); ?>"
><?php  echo $tab_name; ?></a>
				<?php endforeach; ?>
