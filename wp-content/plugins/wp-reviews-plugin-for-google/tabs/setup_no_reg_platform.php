...
/>
<span class="info-text"><?php  echo TrustindexPlugin::___("Type your business/company's Place ID or your Google Search/Google Maps URL"); ?></span>
...
data-errortext-search="<?php  echo TrustindexPlugin::___("Please give us that URL where you can see your business profile in Google Search or in Google Maps! For example: <a href='%s' target='_blank'>illustration</a>, <a href='%s' target='_blank'>illustration</a>", [ 'https://cdn.trustindex.io/' . 'assets/img/trustindex-google-search-1.jpg', 'https://cdn.trustindex.io/' . 'assets/img/trustindex-google-search-2.jpg' ]); ?>"
></div>
</div>
