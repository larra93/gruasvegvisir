...
<li class="<?php  echo !$trustindex_pm_google->is_noreg_linked() ? "active" : "done"; ?><?php  if($current_step == 1): ?> current<?php  endif; ?>" href="?page=<?php  echo $_GET['page']; ?>&tab=setup_no_reg&step=1">
<span>1</span>
		<?php echo TrustindexPlugin::___('Connect %s platform', [ 'Google' ]); ?>

</li>
<span class="ti-free-arrow"></span>
<li class="<?php  echo $style_id ? "done" : ($trustindex_pm_google->is_noreg_linked() ? "active" : ""); ?><?php  if($current_step == 2): ?> current<?php  endif; ?>" href="?page=<?php  echo $_GET['page']; ?>&tab=setup_no_reg&step=2">
<span>2</span>
...
<a href="<?php  echo $trustindex_pm_google->getPageUrl(); ?>" target="_blank"><?php  echo $trustindex_pm_google->getPageUrl(); ?></a>
</div>
...
<div class="preview">
						<?php echo $trustindex_pm_google->get_noreg_list_reviews(null, true, $id, 'light-background', true); ?>
...
<div class="preview">
						<?php echo $trustindex_pm_google->get_noreg_list_reviews(null, true, $style_id, $id, true); ?>
...
<li data-value="4,5" <?php  echo count($filter['stars']) == 2 ? 'class="selected"' : ''; ?>>
								<?php echo $trustindex_pm_google->get_rating_stars(4); ?> - <?php echo $trustindex_pm_google->get_rating_stars(5); ?>

</li>
<li data-value="5" <?php  echo count($filter['stars']) == 1 ? 'class="selected"' : ''; ?>>
								<?php echo TrustindexPlugin::___('only'); ?> <?php echo $trustindex_pm_google->get_rating_stars(5); ?>
...
<label><?php  echo TrustindexPlugin::___("Use site's font"); ?></label>
					...
					<?php if(!in_array(TrustindexPlugin::$widget_templates[ $style_id ]['type'], [ 'badge', 'button' ])): ?>
...
<li>
<strong><?php  echo TrustindexPlugin::___("%d Review Platforms", [ $trustindex_pm_google->get_platform_count() ]); ?></strong><br />
